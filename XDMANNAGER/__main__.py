...
buttons = [
    [
        InlineKeyboardButton(
            text="⚓ Sᴜᴍᴍᴏɴ Mᴇ ⚓", url=f"t.me/{BOT_USERNAME}?startgroup=new"
        ),
    ],
    [
    ...
    [
        ...
        InlineKeyboardButton(text=f"Sᴜᴩᴩᴏʀᴛ ♻️", url=f"https://t.me/{SUPPORT_CHAT}"),
    ],
    [  
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/XD_NETWORK'),
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/XD_NETWORK'),
